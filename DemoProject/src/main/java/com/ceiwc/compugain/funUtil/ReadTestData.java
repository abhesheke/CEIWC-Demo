...
//	Workbook workbook = null;
	...
	public ReadTestData()  {
		...
		String stestcaseFile=Configuration.getTestCaseFile();
		try{
	...
	public ReadTestData(String filename)  {
		...
		String stestcaseFile=null!=filename ? filename : Configuration.getTestCaseFile();
		System.out.println("File path1 :::: "+sexcelFilepath);
		try{
			if(stestcaseFile.contains("src")){
				sexcelFilepath = FileOperation.getFilePath(stestcaseFile);
			System.out.println("File path2 :::: "+sexcelFilepath);
			}
		else{
			sexcelFilepath =stestcaseFile;
			System.out.println("File path3 :::: "+sexcelFilepath);
		}
			System.out.println("File path4 :::: "+sexcelFilepath);
		fis = new FileInputStream(sexcelFilepath);
		}
		catch(Exception e)
		{
	...
	public Iterator<Row> excelFileTye() throws IOException 
	{
...
/*	
	...
	{
		Integer i=1;
		Iterator<Row>  rowIterator= excelFileTye();
	...
	public TreeMap<String,LinkedList> readTestCaseExcel()  {
		LinkedList list;
		Row row;
