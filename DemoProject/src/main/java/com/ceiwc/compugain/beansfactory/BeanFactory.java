...
package com.ceiwc.compugain.beansfactory;
...
public  class BeanFactory implements Setup{
	...
	public void createCustomer(CreateCustomerBean createCustomerBean){
		...
		createCustomerBean.setCustomerid(RandomStringUtils.randomAlphabetic(5));
		createCustomerBean.setCustomername(RandomStringUtils.randomAlphabetic(5));
		createCustomerBean.setCustomeraddress(RandomStringUtils.randomAlphabetic(5));
		createCustomerBean.setPhoneno(RandomStringUtils.randomAlphanumeric(5));
		createCustomerBean.setEmailid(RandomStringUtils.randomAlphabetic(5)+"@mailinator.com");
